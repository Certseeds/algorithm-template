...
#ifndef ALGORITHM_TEMPLATE_ALGORITHM_DP_LEETCODE_643_TEST_CPP
#define ALGORITHM_TEMPLATE_ALGORITHM_DP_LEETCODE_643_TEST_CPP

#include <catch_main.hpp>
#include "leetcode_643.cpp"
...
TEST_CASE("1 [test_643]", "[test_643]") {
    ...
    Solution solution;
    CHECK(result == solution.findMaxAverage(input, k));
}
...
#endif //ALGORITHM_TEMPLATE_ALGORITHM_DP_LEETCODE_643_TEST_CPP
