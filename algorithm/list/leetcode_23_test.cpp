...
#define ALGORITHM_TEMPLATE_ALGORITHM_LIST_LEETCODE_23_TEST_HPP

#include <catch_main.hpp>
#include "leetcode_23.cpp"
...
TEST_CASE("1 [test _23]", "[test _23]") {
    ...
    Solution solution;
    const ListNode *const result = solution.mergeKLists(input);
...
#endif //ALGORITHM_TEMPLATE_ALGORITHM_LIST_LEETCODE_23_TEST_HPP
