...
#ifndef ALGORITHM_TEMPLATE_ALGORITHM_LIST_LEETCODE_338_TEST_HPP
...
TEST_CASE("1 [test_338]", "[test_338]") {
    ...
    Solution solution;
    CHECK_THAT(result, Equals(solution.countBits(input)));
}
...
#endif //ALGORITHM_TEMPLATE_ALGORITHM_LIST_LEETCODE_338_TEST_HPP
